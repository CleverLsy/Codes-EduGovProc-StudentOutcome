...
attach(CountyEduGovProc_IT)
CountyEduGovProc_IT <- CountyEduGovProc_IT %>%
  rename(
...
# 保存为 Stata `.dta` 格式
write_dta(CountyEduGovProc_IT, dta_file_path)
