...
prefecturefile_path <- file.path(root_path, "RawData", "城市县域变量", "1999~2022年县市社会经济指标.dta")

countycityfile_path <- file.path(root_path, "RawData", "城市县域特征", "1999～2022年中国城市统计年鉴县级市面板数据.dta")

countyfile_path<- file.path(root_path, "RawData", "城市县域特征", "1999～2022年中国城市统计年鉴县级市面板数据.dta")
